...
POLICY
  ...
  website {
    ...
    index_document = "${var.version}/index.html"
...
resource "aws_s3_bucket_object" "css" {
  key    = "${var.version}/static/css/main.css"
  bucket = "${aws_s3_bucket.www.id}"
